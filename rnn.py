...
class RNN:
    ...
    def train(self, train_premise: Sequence[Text], train_hypo: Sequence[Text], train_labels: Sequence[Text]):
        ...
        self.model.fit([doc_feat_matrixPremise, doc_feat_matrixHypo], to_categorical(self.lbEncoder.transform(train_labels)), batch_size = self.batch_size, epochs = 50,  callbacks = callbacks_list, verbose = 0)
